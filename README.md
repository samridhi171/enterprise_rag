...
\* \*\*Conversational Memory:\*\* Chat interface that remembers context.

\* \*\*Autonomous Code Execution:\*\* The AI writes its own pandas scripts to find exact answers.

\* \*\*Robust Error Handling:\*\* Custom parsing error bypass for seamless casual conversation.
...
3\. Add a `data.csv` file to the root directory.
